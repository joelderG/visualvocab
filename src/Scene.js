...
import { handleMouseMovement } from "./CameraWithMouseRotation.js";
...
export default class Scene {
  constructor(sceneName) {
    ...
    this.shaderMaterial.uTexture = {
      value: new THREE.TextureLoader().load(forestTexture),
    };
  ...
  onMouseMove(event) {
    ...
    handleMouseMovement(mouse.x, mouse.y, this.cameraOrientationState);
  }
}
